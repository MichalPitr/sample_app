...
class FollowTest < Following
  ...
  test 'should follow a user with page refresh on follow' do
  ...
  test 'should follow a user with hotwire without page refresh' do
    assert_difference '@user.following.count', 1 do
...
class UnfollowTest < Unfollow
  ...
  test 'should unfollow a user with page refresh' do
    assert_difference '@user.following.count', -1 do
